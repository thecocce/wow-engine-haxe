...
package fr.seraf.wow.math;
	...
	**/
	class WVectorMath {
		 ...
		 */
		public static function getNorm( v:WVector ):Float
		{
		 ...
		 * @return The resulting {@code Vector}.
		 */
		public static function pow( v:WVector, pow:Float ): WVector
		{
		 ...
		 * @return The resulting {@code Vector}.
		 */
		public static function scale( v:WVector, n:Float ): WVector
		{
		 ...
		 */
		public static function dot( v: WVector, w: WVector):Float
		{
		 ...
		 *
		 * @param {@code v} a {@code Vector}.
		 * @return a Bool true for success, false for mistake.
		 */	
		public static function normalize( v:WVector ): Bool
		{
			// -- We get the norm of the vector
			var norm:Float = WVectorMath.getNorm( v );
		...
		* @return 	Float	The angle in radian between the two vectors.
		*/
		public static function getAngle ( v:WVector, w:WVector ):Float
		{
			var ncos:Float = WVectorMath.dot( v, w ) / ( WVectorMath.getNorm(v) * WVectorMath.getNorm(w) );
		 ...
		 * @return The resulting {@code Vector}.
		 */
		public static function divEquals(v:WVector,s:Float):WVector {
			if (s == 0) s = 0.0001;
		 ...
		 */
		public static function distance(v:WVector, w:WVector ):Float {
