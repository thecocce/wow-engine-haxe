...
package fr.seraf.wow.core.face;
	...
	class WPolygon implements WIPolygon {
	
		private var _aVertex:Array<Dynamic>;
		...
		public function new( oref:WOWPlane, rest:Array<Dynamic>) {
			_o = oref;
		...
		*/
		public function toString():String {
			return "WPolygon"/*getQualifiedClassName(this) */+ " [PoInts: " + _aVertex.length +"]";
		}
