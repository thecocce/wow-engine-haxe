...
//	import flash.utils.getQualifiedClassName;
	...
	*/
	class WVertex extends WVector
	{
		...
		* If no
		* @param px the x position Float
		* @param py the y position Float
		* @param pz the z position Float
		* 
		*/
		public function new(px:Float = 0, py:Float = 0, pz:Float = 0)
		{
			super(px,py,pz);
		...
		*/
		...
		{
			return "WVertex"/*getQualifiedClassName(this)*/ + "(x:"+x+" y:"+y+" z:"+z+"\nwx:"+wx+" wy:"+wy+" wz:"+wz+"\nsx:" + sx + " sy:"+ sy + ", sz:" + sz +")";
		}
