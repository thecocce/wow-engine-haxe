...
package fr.seraf.wow.structure;
	...
	**/
	class ConstraintList
	{
    	...
    	{
    		var l_aList:Array<Dynamic> = new Array();
    	...
    	public function removeNode( p_oElt:ConstraintNode ):Bool
    	{
    		if( p_oElt == head )
    		{
    			head = head.next;
    	...
    	public function removeValue( p_oElt:WBaseConstraint ):Bool
    	{
